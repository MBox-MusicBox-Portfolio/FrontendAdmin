    ...
    data() {
        return {
            ...
            groupList: [
                ...
                {index: 1, group_img: 'https://logos-download.com/wp-content/uploads/2016/02/BMW_dark_logo.jpg', name: 'GrekaPrivate', status: 'Pending', img_url: 'https://openclipart.org/image/800px/328181', producer:'Den'},
